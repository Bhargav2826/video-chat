...
function Student() {
    ...
    useEffect(() => {
        ...
        const fetchUsers = async () => {
            try {
                ...
                // Only show faculty members to students
    ...
    const sendMessage = (e) => {
        ...
        socket.emit("send-message", {
            senderId: userId,
            senderModel: "Student", // Known for this page
            receiverId: selectedUser._id,
            receiverModel: "Faculty", // Students only talk to faculty
            text: newMessage
        });
    };
    ...
    return (
        <div className="h-screen flex flex-col bg-gray-950 text-white overflow-hidden">
            ...
            <div className="flex-grow flex overflow-hidden bg-gray-100 shadow-2xl antialiased text-gray-900">
                    ...
                    <div className={`flex-grow relative flex flex-col ${isMinimized ? "p-0" : "md:flex-row gap-8 p-10 pt-36 h-full"}`}>
                        ...
                        <div className={`${isMinimized
                            ...
                            {callType === "video" ? (
                                ...
                                <div className="absolute inset-0 bg-gray-900 flex items-center justify-center">
                                    <div className="w-20 h-20 rounded-full bg-blue-600 flex items-center justify-center text-white text-3xl font-black shadow-lg animate-pulse">
